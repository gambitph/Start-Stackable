...
/**
 * Title: Archive
 * Slug: start-stackable/template-archive
 * Categories: posts
...
<div class="wp-block-group alignwide" style="margin-bottom:var(--wp--preset--spacing--x-large)"><!-- wp:query-title {"type":"archive","showPrefix":false,"fontSize":"xx-large"} /-->

<!-- wp:term-description {"textColor":"contrast-accent"} /--></div>
<!-- /wp:group -->
...
<p class="has-contrast-accent-color has-text-color"><?php esc_html_e( 'No posts were found in this archive.', 'start-stackable' ); ?></p>
<!-- /wp:paragraph -->
