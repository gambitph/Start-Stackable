...
The theme owns chrome, templates, `theme.json` tokens, style variations, and header *behavior* (sticky, transparent, hide).
...
If a kit needs a new chrome behavior, add it to this theme (and the contract) instead of faking it in Stackable CSS.
