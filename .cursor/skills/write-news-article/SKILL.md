...
1. If this is a theme, use `Version:` in root `style.css`
2. Else prefer `Version:` in root `plugin.php`
3. Else main plugin bootstrap PHP
4. Optionally note `Stable tag:` in `readme.txt`
